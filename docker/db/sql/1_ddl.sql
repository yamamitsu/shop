...
INSERT INTO m_questions (question_id, parent_id, caption, subtext) VALUES 
(1, NULL, 'BCPの総論を記入します。(1)', NULL)
,(2, NULL, '基本方針を記入します。(2)', '本計画に関する基本方針を以下のとおりとする。')
,(3, NULL, '全体像', '自然災害(地震・水害等)BCPのフローチャート')
,(4, NULL, '推進体制', '（平常時の災害対策の推進体制を記載する。）')
,(5, NULL, 'リスクの把握', NULL)
,(6, 5, '（1）ハザードマップなどの確認', NULL)
,(7, 5, '（2）被害想定', '【自治体公表の被災想定】')
,(8, 5, '（2.1）被害想定', '【自事業所で想定される影響】')
,(9, NULL, '優先業務の選定', NULL)
;
