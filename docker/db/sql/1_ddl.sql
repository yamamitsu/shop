...
-- 
--
-- DROP TABLE IF EXISTS `user`;do
CREATE TABLE `user`
(
    `user_id`   INT NOT NULL AUTO_INCREMENT             COMMENT 'ID',
    `last_name` VARCHAR(30) NOT NULL                    COMMENT 'ユーザー名(姓)',
    `first_name`VARCHAR(30) NOT NULL                    COMMENT 'ユーザー名(名)',
    `kana_last_name` VARCHAR(30) NOT NULL               COMMENT 'ユーザー名仮名(姓)',
    `kana_first_name` VARCHAR(30) NOT NULL              COMMENT 'ユーザー名仮名(名)',
